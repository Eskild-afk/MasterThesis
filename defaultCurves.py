...
# sns.lineplot(x=np.arange(0, 15, 1/365), y=[lI(t)*10000 for t in np.arange(0, 15, 1/365)], label='CDS Spreads for Investor')
# sns.lineplot(x=np.arange(0, 15, 1/365), y=[lC(t)*10000 for t in np.arange(0, 15, 1/365)], label='CDS Spreads for Counterparty')
# ax.set_xlabel('Tenor (Years)', fontname="Times New Roman", fontsize = 28)
# ax.set_ylabel('Spread (in BP)', fontname="Times New Roman", fontsize = 28)
...
# fig, ax = plt.subplots()
# fig.set_size_inches(15,8)
# sns.lineplot(x=np.arange(0, 15, 1/365), y=[QI(t)*100 for t in np.arange(0, 15, 1/365)], label='Default probability for Investor')
# sns.lineplot(x=np.arange(0, 15, 1/365), y=[QC(t)*100 for t in np.arange(0, 15, 1/365)], label='Default probability for Counterpart')
# ax.set_xlabel('Time (Years)', fontname="Times New Roman", fontsize = 28)
# ax.set_ylabel('Cumulative survival probability (in Percent)', fontname="Times New Roman", fontsize = 28)
# ax.tick_params(axis='x', direction='in', right = 'True', labelsize = 24, pad = 15)
# ax.tick_params(axis='y', direction='in', top = 'True', labelsize = 24, pad = 15)
# ax.axhline(y=0, color='k', alpha = 0.25)
# plt.grid(alpha = 0.25)
